...
initPhxSocket username =
    Phoenix.Socket.init (socketServer username)
        ...
        |> Phoenix.Socket.on "new:msg" "world:lobby" ReceiveChatMessage
        |> Phoenix.Socket.on "presence_state" "world:lobby" HandlePresenceState
        |> Phoenix.Socket.on "presence_diff" "world:lobby" HandlePresenceDiff
        ...
        JoinChannel ->
            case model.phxSocket of
                ...
                Just modelPhxSocket ->
                    let
                        channel =
                            Phoenix.Channel.init "world:lobby"
            ...
            case model.phxSocket of
                ...
                Just modelPhxSocket ->
                    let
                        ...
                        pushPrime =
                            Phoenix.Push.init "new:msg" "world:lobby"
